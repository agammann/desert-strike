...
The reference is **Desert Strike: Return to the Gulf for Genesis / Mega Drive (1992)**. This v0.3.0 recreation runs on its own JavaScript engine. It does not load a ROM or emulate the original executable. A successful campaign test does not establish identical difficulty or frame timing.
...
The player begins with 600 armor, 1,178 cannon rounds, 38 Hydras, eight Hellfires, three lives and a six-person cabin. Cannon/Hydra/Hellfire damage is 3/25/100. The quick ladder and extra-life pickups are concealed in destructible buildings. The game preserves fuel over water and requires finite supply pickups in Standard.
...
- Collidable buildings and scenery block the aircraft and inflict armor damage. Collision shapes and the 10-point damage value are reconstruction choices.
...
| Presentation | Original cutscenes, music, exact animation frames, copilot selection, passwords and original scoring are not reproduced. No mid-campaign save. |
